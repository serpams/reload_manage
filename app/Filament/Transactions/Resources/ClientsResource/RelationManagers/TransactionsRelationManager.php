...
namespace App\Filament\Transactions\Resources\ClientsResource\RelationManagers;
...
class TransactionsRelationManager extends RelationManager
{
    ...
    {
        // $sites_id = fn (Get $get) => $get('clients_id');
        return $form
            ->schema([
                Forms\Components\DateTimePicker::make('data')
                    ->required()->default(now())->readOnly(true),
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('data')->dateTime('d/m/y H:i:s'),
                ...
                Tables\Columns\TextColumn::make('valor_convertido_considerado')->money('BRL')
                    ->summarize(Sum::make()->label('Lucro entre ( Compra - venda )'))->money('BRL')->label('Operacao'),
            ])
            ->filters([
